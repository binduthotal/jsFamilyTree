var params = {
    ...
    dataLoadUrl: "seepareddyBackUp.json",
    data: null,
    funcs: {
        showMySelf: null,
        search: null,
...
function onWindowLoad() {
    ...
    // Firebase database code for hosting
    ...
    //Local testing code
    var data = d3.json(params.dataLoadUrl).then(function(jsonData){
            ...
            function drawOrganizationChart() {
                ...
                function editProfile(id) {
                  ...
                  function saveDetails(id) {
                    ...
                    // Local Testing
                    // localStorage.setItem('seepareddyBackUp',JSON.stringify(attrs.root))
                    // var obj = JSON.parse(localStorage.getItem('seepareddyBackUp'));
                    var newData = JSON.stringify(attrs.root);
                  ...
                  function viewSpouseProfile(d, sId) {
                    ...
                    d.data.spouses.forEach((id) => {
                      if (id.suniqueid === sId) {
                        ...
                        debugger
                        if (id.gothram) {
                          strVar +="<p class=gothram id=p-gothram-id>" + id.gothram + "</p>";
                          strVar +="<input class=gothram-row id=gothram-id value=Gothram style=display:none>";
                        ...
                        strVar += "<div class=person-details-row>";
                        strVar += "<div class=coln-25>";
                        strVar +='<label>Date of Birth:  </label><p style="margin-top:0; font-size:11px">Date: DD/MM/YYYY</p>';
                        strVar += "</div> ";
                        strVar += "<div class=coln-75>";
                        if (id.dob) {
                          ...
                          strVar +="<input class=dob-row id=dob-id placeholder=DD/MM/YYYY maxlength=10 value=01/01/2021>";
                        }
                        strVar += "</div>";
                        strVar += "</div>";
